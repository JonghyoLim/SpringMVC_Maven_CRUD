...
public class Breweries implements Serializable {
    ...
    @Size(min = 1, max = 250, message = "must be 250 characters or at least 2")
    private String name;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 250, message = "must be 250 characters or at least 2")
    ...
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 30, message = "must be 30 characters or at least 2")
    @Column(name = "city")
    private String city;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 20, message = "must be 20 characters or at least 2")
    @Column(name = "state")
    ...
    @NotBlank(message = " field cannot be empty")
    @Pattern(regexp="\\d{1,5}", message = "must be 5 digits or at leat 1")
    //@digit
    @Column(name = "code")
    private String code;
    @Basic(optional = false)
   ...
   // @Pattern(regexp="[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?", message="Invalid email")//if the field contains email address consider using this annotation to enforce field validation
    ...
    @NotBlank(message = " this field cannot be blank")
    @Column(name = "email")
   @Email(message= " Required valid email adress")
